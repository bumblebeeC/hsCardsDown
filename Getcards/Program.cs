...
namespace Getcards
{
    ...
    class Program
    {
        ...
        static int prePage = 0;
        static int TotalPage = 0;
        static int NextPage = 7;
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < cardList.Length; i++)
            {
               ...
               Console.WriteLine(GetPostData(cardList[i], NextPage));

               Console.WriteLine(p.totalPage + "  " + p.prePage);
               TotalPage = p.totalPage;
               

               while (TotalPage > prePage)
                {
                   NextPage = p.nextPage; 
